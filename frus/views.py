...
def Happo(request):  
    if request.method=='POST':
        ...
        send_mail('Request to fix an appointment with '+counsellor, 'I, '+name+' want to have one-on-one session with you. My issue is: '+content, settings.EMAIL_HOST_USER, [email], fail_silently=False)
...
def contact(request):
    if request.method=='POST':
        ...
        content=request.POST['content']
        send_mail('Contact form', content, settings.EMAIL_HOST_USER, [email], fail_silently=False)
